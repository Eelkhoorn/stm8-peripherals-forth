...
: OPP  %110 ;     \ output push/pull
: OPPF %111 ;     \ output push/pull fast
: OOD  %100 ;     \ output open drain
: OODF %101 ;     \ output open drain fast
: IFL  %000 ;     \ input floating
: IFLI %001 ;     \ input floating with interrupt
: IP   %010 ;     \ input pull-up 
: IPI  %011 ;     \ input pull-up with interrupt
